h1. Forked version compatible with v6.8.x Morphological Analysis Plugin for ElasticSearch
...
*NOTE:* For Elasticsearch version 6.0 and above consider switching to the officially supported <a href="https://www.elastic.co/guide/en/elasticsearch/reference/current/analysis-hunspell-tokenfilter.html">hunspell</a> token filter with russian dictionaries.
...
|        ----                     | 6.8.5+  | build yourself: gradlew build |
